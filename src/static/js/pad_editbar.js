...
//      return !$("#editbar").hasClass('disabledtoolbar');
    ...
    setEmbedLinks: function()
    {
      ...
      else
      {
        ...
        $('#embedinput').val("<iframe name='embed_readwrite' src='" + padurl + "?showControls=true&showChat=true&showLineNumbers=false&useMonospaceFont=false' width=600 height=400></iframe>");
